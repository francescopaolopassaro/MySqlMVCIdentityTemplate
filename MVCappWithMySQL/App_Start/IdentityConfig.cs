...
namespace MVCappWithMySQL
{
    ...
    public class ApplicationUserManager : UserManager<IdentityUser>
    {
     ...
     context.Get<IdentityDbContext>() as MySQLDatabase));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            var manager = new ApplicationRoleManager(new RoleStoreRepository<IdentityRole>(context.Get<IdentityDbContext>()));
            return manager;
        }
